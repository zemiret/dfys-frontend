...
@Component({
  selector: 'dfys-skills-sidebar-tree',
  templateUrl: './skills-sidebar-tree.component.html',
  styleUrls: ['./skills-sidebar-tree.component.scss'],
})
export class SkillsSidebarTreeComponent extends SubscriptionHandler
  implements OnInit {
